...
router.post("/request", requireAuth, validateDTO(CreateTakedownRequestDTO), TakedownController.create);
...
router.patch("/:id/review", requireRoles(UserRole.ADMIN), validateDTO(ReviewTakedownRequestDTO), TakedownController.review);
