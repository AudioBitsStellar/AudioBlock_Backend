export const ArtistFacetABI = [
  { inputs: [], name: 'ARTIST_ALREADY_REGISTERED', type: 'error' },
  { inputs: [], name: 'ARTIST_NOT_FOUND', type: 'error' },
  ...
  { inputs: [], name: 'ZeroAddress', type: 'error' },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: 'string', name: 'artistCid', type: 'string' },
      { indexed: true, internalType: 'uint256', name: 'artistTokenId', type: 'uint256' },
    ],
    ...
    outputs: [
      {
        components: [
          ...
          { internalType: 'string', name: 'artistCid', type: 'string' },
          { internalType: 'uint256', name: 'artistTokenId', type: 'uint256' },
          { internalType: 'bool', name: 'isRegistered', type: 'bool' },
          { internalType: 'uint256[]', name: 'songTokenIds', type: 'uint256[]' },
        ],
        internalType: 'struct LibAppStorage.Artist',
        name: '',
        type: 'tuple',
      },
    ],
